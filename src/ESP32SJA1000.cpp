...
// Only compile for ESP32 variants with built-in SJA1000 CAN controller
// ESP32-C3, C6, H2, C2 don't have this hardware and need external CAN controller
...
ESP32SJA1000Class::ESP32SJA1000Class() :
  CANControllerClass(),
  _rxPin((gpio_num_t)DEFAULT_CAN_RX_PIN),
  _txPin((gpio_num_t)DEFAULT_CAN_TX_PIN),
  _loopback(false),
  _intrHandle(NULL)
{
}
